...
public class FragmentSports extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sports_recyclerview = view.findViewById(R.id.sports_recyclerview);
        class_modelArrayList = new ArrayList<>();
        sports_recyclerview.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Class_Adapter(class_modelArrayList, getContext());
        sports_recyclerview.setAdapter(adapter);
