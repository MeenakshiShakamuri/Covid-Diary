...
public class FragmentEntertainment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        entertainment_recyclerview = view.findViewById(R.id.entertainment_recyclerview);
        class_modelArrayList = new ArrayList<>();
        entertainment_recyclerview.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Class_Adapter(class_modelArrayList, getContext());
        entertainment_recyclerview.setAdapter(adapter);
